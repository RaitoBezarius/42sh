/*
** parse_passes.c for 42sh in /home/bebe-b_h/projects/42sh/src/parsing
**
** Made by BEBE-BELL Hendy-Wilson
** Login   <bebe-b_h@epitech.eu>
**
** Started on  Fri Jun 05 08:22:09 2015 BEBE-BELL Hendy-Wilson
** Last update Fri Jun 05 08:31:33 2015 BEBE-BELL Hendy-Wilson
*/
...
int analyze_command_argv(t_linked_list	**nodes_list)
{
  ...
  while ((*nodes_list))
  {
	...
	command->execute = standard_execute;
      ...
      command->argv = str_to_wordtab(command->executable, ' ');
    }
